...
| 平台 | 来源 |
| --- | --- |
| Arch Linux | AUR：`yay -S pdf-compressor-bin`（二进制包，源为 [Releases](https://github.com/cosct/pdf-compressor/releases) 资产）或 `yay -S pdf-compressor`（源码包）；本地自建可用 `pnpm run tauri:arch` |
